// Consts
const apikey = "f1251486a45be8326f310302a4b06d45";
...
const apiPaths = {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyBeSSV3lJXzMABmZ01V3cH0bF544CpFhlg`
}
...
function searchMovieTrailer(movieName, iframId) {
    ...
    .then(res => {
        ...
        const div = document.createElement('div');
        div.innerHTML = `<iframe width="245px" height="150px" src="https://www.youtube.com/embed/${bestResult.id.videoId}?autoplay=0&controls=0"></iframe>`
